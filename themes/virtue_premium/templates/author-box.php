				...
				<div class="author-follow"><span class="followtext"><?php esc_attr_e( 'Follow', 'virtue' ); ?> <?php the_author_meta( 'display_name' ); ?>:</span>
					...
					if ( get_the_author_meta( 'twitter' ) ) {
						...
						<span class="twitterlink">
							<a href="http://twitter.com/<?php the_author_meta( 'twitter' ); ?>" target="_blank" title="<?php esc_attr_e( 'Follow', 'virtue' ); ?>  <?php the_author_meta( 'display_name' ); ?> <?php esc_attr_e( 'on X formerly Twitter', 'virtue' ); ?>"><i class="icon-twitter"></i></a>
						</span>
						<?php
					}
