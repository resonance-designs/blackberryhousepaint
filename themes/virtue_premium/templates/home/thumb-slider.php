...
<div class="sliderclass clearfix home_desk_slider">
	<div id="imageslider" class="container">
		<?php
		virtue_build_slider_home( virtue_premium_get_option( 'home_slider' ), virtue_premium_get_option( 'slider_size_width', '1140' ), virtue_premium_get_option( 'slider_size', '400' ), 'kt-slider-same-image-ratio', 'kt_slider_home', 'thumb', $captions, $autoplay, virtue_premium_get_option( 'slider_pausetime', '7000' ), 'true', $trans_type, virtue_premium_get_option( 'slider_transtime', '300' ) );
		?>
	</div><!--Container-->
</div><!--sliderclass-->
