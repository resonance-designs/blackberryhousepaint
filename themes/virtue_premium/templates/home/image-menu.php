...
<div class="home-padding home-margin">
	...
	if(!empty($slides)) {
		foreach ($slides as $slide) :
			...
			echo virtue_image_menu_output_builder( $slide['attachment_id'], $height_setting, $height, $slide['link'], $columns, $target, $slide['title'], $slide['description'], $class, $slide['url'], $counter, $counter*150);
