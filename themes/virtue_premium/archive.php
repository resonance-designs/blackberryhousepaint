    ...
    */
	...
	<div id="content" class="container">
		<div class="row">
			...
			<?php if($summary == 'full'){ ?>
				<div class="kt_archivecontent <?php echo esc_attr($scrollclass); ?>" data-nextselector=".wp-pagenavi a.next" data-navselector=".wp-pagenavi" data-itemselector=".kad_blog_item" data-itemloadselector=".kad-animation" data-infiniteloader="<?php echo esc_url(get_template_directory_uri() .'/assets/img/loader.gif'); ?>"> 
					<?php 
