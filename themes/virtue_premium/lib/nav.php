...
class kadence_Nav_Walker extends Virtue_Nav_Walker {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		error_log( 'The kadence_Nav_Walker class is deprecated since version 4.6.9. Please use Virtue_Nav_Walker instead.' );
...
class kadence_mobile_walker extends Virtue_Mobile_Nav_Walker {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		error_log( 'The kadence_mobile_walker class is deprecated since version 4.6.9. Please use Virtue_Mobile_Nav_Walker instead.' );
		parent::start_lvl( $output, $depth, $args );
	}
}
