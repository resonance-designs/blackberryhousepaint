...
function virtue_shortcode_button_scripts(){
	...
	wp_enqueue_script('kad_shortcode',get_template_directory_uri() . '/lib/kad_shortcodes/js/kad_shortcode_pop.js',array( 'jquery', 'wp-color-picker' ),'4.9.30 ', TRUE);
}
...
$virtue_shortcodes['kad_youtube'] = array( 
	...
	'attr'=>array(
		...
		'hideinfo' => array(
			'type'  => 'checkbox',
			'title' => __( 'Hide title and player actions', 'virtue' ),
		),
		'autoplay'=>array(
			'type'=>'checkbox', 
