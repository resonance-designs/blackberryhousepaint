...
function virtue_woocommerce_core_hooks() {
	...
	/**
	 * Add Tabs to some product search
	 */
	function virtue_indexer_filter_content( $content, $context, $post_id ) {
		if ( $context === 'post_content' ) {
			$fields = array( '_kad_tab_content_01', '_kad_tab_content_02', '_kad_tab_content_03' );
	...
	add_filter( 'woocommerce_product_search_indexer_filter_content', 'virtue_indexer_filter_content', 10, 3 );
