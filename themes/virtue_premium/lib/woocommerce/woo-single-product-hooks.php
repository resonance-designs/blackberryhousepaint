...
function kad_product_custom_tab_content_01() {
	...
	echo '<div class="product_custom_content_case">' . wpautop( do_shortcode( apply_filters( 'kadence_custom_woo_tab_01_content', $tab_content_01 ) ) ) . '</div>';
}
...
function kad_product_custom_tab_content_02() {
	...
	echo '<div class="product_custom_content_case">' . wpautop( do_shortcode( apply_filters( 'kadence_custom_woo_tab_02_content', $tab_content_02 ) ) ) . '</div>';
...
function kad_product_custom_tab_content_03() {
	...
	echo '<div class="product_custom_content_case">' . wpautop( do_shortcode( apply_filters( 'kadence_custom_woo_tab_03_content', $tab_content_03 ) ) ) . '</div>';
}
...
function kad_woo_variation_ratio_output() {
	...
	if ( ! function_exists( 'kadence_wc_radio_variation_attribute_options' ) ) {
		function kadence_wc_radio_variation_attribute_options( $args = array() ) {
			...
			echo '<fieldset class="kad_radio_variations" role="radiogroup" name="' . esc_attr( $name ) . '" data-attribute_name="attribute_' . esc_attr( sanitize_title( $attribute ) ) . '">';
			if ( ! empty( $options ) ) {
