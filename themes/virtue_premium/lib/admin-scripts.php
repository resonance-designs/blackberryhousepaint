...
function virtue_admin_scripts( $hook ) {
	wp_register_style( 'kadence-blocks-install', get_template_directory_uri() . '/assets/css/blocks-admin-activate.css', false, VIRTUE_VERSION );
	wp_register_script( 'kadence-blocks-install', get_template_directory_uri() . '/assets/js/blocks-admin-activate.js', false, VIRTUE_VERSION );

	if ( 'toplevel_page_kad_options' === $hook ) {
		if ( class_exists( 'ReduxFramework' ) && ReduxFramework::$_version >= '4.0.0' ) {
...
function virtue_editor_dynamic_css() {
	...
	if ( ( method_exists( $current_screen, 'is_block_editor' ) && $current_screen->is_block_editor() ) || ( function_exists( 'is_gutenberg_page' ) && is_gutenberg_page() ) ) {
		...
		foreach ( $options_fonts as $options_key ) {
			if ( isset( $virtue_premium[ $options_key ] ) && isset( $virtue_premium[ $options_key ]['google'] ) && true == $virtue_premium[ $options_key ]['google'] ) {
		...
		if ( isset( $virtue_premium['font_h1'] ) ) {
			echo 'body.block-editor-page .editor-post-title__block .editor-post-title__input, body.block-editor-page .wp-block-heading h1, body.block-editor-page .editor-block-list__block h1, body.block-editor-page .editor-post-title__block .editor-post-title__input  {
					...
					font-weight: ' . esc_attr( ( isset( $virtue_premium['font_h1']['font-weight'] ) ? $virtue_premium['font_h1']['font-weight'] : '400' ) ) . ';
					font-family: ' . esc_attr( $virtue_premium['font_h1']['font-family'] ) . ';
					color: ' . esc_attr( ( isset( $virtue_premium['font_h1']['color'] ) && ! empty( $virtue_premium['font_h1']['color'] ) && '#ffffff' !== $virtue_premium['font_h1']['color'] ? $virtue_premium['font_h1']['color'] : '' ) ) . ';
				}';
		}
		if ( isset( $virtue_premium['font_h2'] ) ) {
			echo 'body.block-editor-page .wp-block-heading h2, body.block-editor-page .editor-block-list__block h2 {
				...
				font-weight: ' . esc_attr( ( isset( $virtue_premium['font_h2']['font-weight'] ) ? $virtue_premium['font_h2']['font-weight'] : '400' ) ) . ';
				font-family: ' . esc_attr( $virtue_premium['font_h2']['font-family'] ) . ';
				color: ' . esc_attr( ( isset( $virtue_premium['font_h2']['color'] ) && ! empty( $virtue_premium['font_h2']['color'] ) && '#ffffff' !== $virtue_premium['font_h2']['color'] ? $virtue_premium['font_h2']['color'] : '' ) ) . ';
			}';
		}
		if ( isset( $virtue_premium['font_h3'] ) ) {
			echo 'body.block-editor-page .wp-block-heading h3, body.block-editor-page .editor-block-list__block h3 {
				...
				font-weight: ' . esc_attr( ( isset( $virtue_premium['font_h3']['font-weight'] ) ? $virtue_premium['font_h3']['font-weight'] : '400' ) ) . ';
				font-family: ' . esc_attr( $virtue_premium['font_h3']['font-family'] ) . ';
				color: ' . esc_attr( ( isset( $virtue_premium['font_h3']['color'] ) && ! empty( $virtue_premium['font_h3']['color'] ) && '#ffffff' !== $virtue_premium['font_h3']['color'] ? $virtue_premium['font_h3']['color'] : '' ) ) . ';
			}';
		}
		if ( isset( $virtue_premium['font_h4'] ) ) {
			echo 'body.block-editor-page .wp-block-heading h4, body.block-editor-page .editor-block-list__block h4 {
				...
				font-weight: ' . esc_attr( ( isset( $virtue_premium['font_h4']['font-weight'] ) ? $virtue_premium['font_h4']['font-weight'] : '400' ) ) . ';
				font-family: ' . esc_attr( $virtue_premium['font_h4']['font-family'] ) . ';
				color: ' . esc_attr( ( isset( $virtue_premium['font_h4']['color'] ) && ! empty( $virtue_premium['font_h4']['color'] ) && '#ffffff' !== $virtue_premium['font_h4']['color'] ? $virtue_premium['font_h4']['color'] : '' ) ) . ';
		...
		if ( isset( $virtue_premium['font_h5'] ) ) {
			echo 'body.block-editor-page .wp-block-heading h5, body.block-editor-page .editor-block-list__block h5 {
				...
				font-weight: ' . esc_attr( ( isset( $virtue_premium['font_h5']['font-weight'] ) ? $virtue_premium['font_h5']['font-weight'] : '400' ) ) . ';
				font-family: ' . esc_attr( $virtue_premium['font_h5']['font-family'] ) . ';
				color: ' . esc_attr( ( isset( $virtue_premium['font_h5']['color'] ) && ! empty( $virtue_premium['font_h5']['color'] ) && '#ffffff' !== $virtue_premium['font_h5']['color'] ? $virtue_premium['font_h5']['color'] : '' ) ) . ';
			}';
		}
		if ( isset( $virtue_premium['font_p'] ) ) {
			echo '.edit-post-visual-editor, .edit-post-visual-editor p, .edit-post-visual-editor.editor-styles-wrapper p {
				...
				font-weight: ' . esc_attr( ( isset( $virtue_premium['font_p']['font-weight'] ) ? $virtue_premium['font_p']['font-weight'] : '400' ) ) . ';
