...
jQuery(document).ready(function($){
	...
	$('#kad-shortcode-insert').click(function(){
		...
		if(scname == 'columns') {
    		...
    		var columns = $('#options-'+scname+' .kad-sc-columns').val() != '' ? parseInt( $('#options-'+scname+' .kad-sc-columns').val()) : 2;
    		var rows = $('#options-'+scname+' .kad-sc-rows').val() != '' ? parseInt( $('#options-'+scname+' .kad-sc-rows').val()) : 2;
    		var head = $('#options-'+scname+' #head').is(':checked') ? true : false;
			...
			if($(this).val() != '' && $(this).val() != undefined) {
				sc_attrs += ' ' + $(this).attr('id') + '="' + $(this).val() + '"';
					}
				});
			...
			if($(this).val() != '' && $(this).val() != undefined) {
				sc_attrs += ' ' + $(this).attr('data-attrname') + '="' + $(this).val() + '"';
			}
			});
			...
			sc_title = $('#options-'+scname+' [type="text"].kad-sc-title').val();
		...
		$('#options-'+scname+' input[type=checkbox]').each(function(){
			 if($(this).is(':checked') ) sc_attrs += ' ' + $(this).attr('data-attrname')+'="true"';	
		});
		code += sc_attrs;
