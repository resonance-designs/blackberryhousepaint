...
/**
 * Shortcode Function for staff Posts
 *
...
function kad_staff_shortcode_function( $atts, $content ) {
	...
	if ( 'true' == $filter ) {
		...
		<section id="options" class="clearfix">
			...
			$alltext         = virtue_premium_get_option( 'filter_all_text', __( 'All', 'virtue' ) );
			$stafffiltertext = virtue_premium_get_option( 'portfolio_filter_text', __( 'Filter Staff', 'virtue' ) );
	...
	?>
		<div id="staffwrapper-<?php echo esc_attr( $id ); ?>" class="rowtight init-isotope reinit-isotope" data-fade-in="<?php echo esc_attr( virtue_animate() ); ?>" data-iso-selector=".s_item" data-iso-style="<?php echo esc_attr( $iso_style ); ?>" data-iso-filter="<?php echo esc_attr( $sft ); ?>"> 
			<?php
			$wp_query = null;
