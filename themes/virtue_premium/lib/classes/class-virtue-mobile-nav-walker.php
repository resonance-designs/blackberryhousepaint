...
class Virtue_Mobile_Nav_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_output .= '</a>';
		if ( $has_sub ) {
			$item_output .= '<button class="kad-submenu-accordion collapse-next kad-submenu-accordion-open" data-parent=".kad-nav-collapse" data-toggle="collapse"><i class="icon-arrow-down"></i><i class="icon-arrow-up"></i></button>';
		}
